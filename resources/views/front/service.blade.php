...
@section('content')
    <div class="intro-section" style="background-image: url('images/banner-3.png');">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mx-auto text-center" data-aos="fade-up">
                    <h1>{{__('messages.f20')}}</h1>
                    ...
                    <p><a href="#" class="btn btn-primary py-3 px-5">{{__('messages.contact')}}</a></p>
                </div>
            </div>
        </div>
    </div>
