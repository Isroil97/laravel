                    ...
                    <div class="col-lg-3 d-none d-lg-block">
                        <div class="quick-contact-icons d-flex">
                            ...
                            <div class="text">
                                ...
                                <span class="caption-text"><?php echo e(__('messages.phone')); ?></span>
                            </div>
                        </div>
                    </div>
                            ...
                            <nav class="site-navigation position-relative text-right" role="navigation">
                                <ul class="site-menu main-menu js-clone-nav mr-auto d-none pl-0 d-lg-block">
                                    <li class="<?php echo e('/' == request()->path() ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('index')); ?>" class="nav-link text-left"><?php echo e(__('messages.home')); ?></a>
                                    </li>
                                    <li class="<?php echo e('blog' == request()->path() ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('blog')); ?>" class="nav-link text-left"><?php echo e(__('messages.blog')); ?></a>
                                    </li>
                                    <li class="<?php echo e('about' == request()->path() ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('about')); ?>" class="nav-link text-left"><?php echo e(__('messages.about')); ?></a>
                                    </li>
                                    <li class="<?php echo e('service' == request()->path() ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('service')); ?>" class="nav-link text-left"><?php echo e(__('messages.service')); ?></a>
                                    </li>

                                    <li class="<?php echo e('galereya' == request()->path() ? 'active' : ''); ?>">
                                      <a href="<?php echo e(route('galereya')); ?>" class="nav-link text-left"><?php echo e(__('messages.photos')); ?></a>
                                    </li>

                                    <li class="<?php echo e('contact' == request()->path() ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('contact')); ?>" class="nav-link text-left"><?php echo e(__('messages.contact')); ?></a>
                                    </li>
                                            ...
                                            <?php $__currentLoopData = Config::get('languages'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($lang != App::getLocale()): ?>
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(route('lang.switch', $lang)); ?>"><span
        ...
        <div class="footer bg-dark">
            <div class="container">
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-3">
                        <h3 class="footer-heading"><span style="color: white; ;"><?php echo e(__('messages.f22')); ?></span></h3>
                    ...
                    <div class="col-lg-3">
                        <h3 class="footer-heading"><span><?php echo e(__('messages.contact')); ?></span></h3>
                        <ul class="list-unstyled">
                    ...
                    <div class="col-lg-3">
                        <h3 class="footer-heading"><span><?php echo e(__('messages.f23')); ?></span></h3>
                        <ul class="list-unstyled">
...
<?php /**PATH D:\OpenServer\domains\Turizim\resources\views/layout/index.blade.php ENDPATH**/ ?>